...
public class Ellipse implements Shape {
	...
	/**
	 * Creates a new ellipse from info embedded in server/client commands
	 * @param parts list of strings with information describing desired ellipse
	 * @return generated ellipse from information
	 */
	public static Ellipse generateShapeFromParts (String[] parts) {
